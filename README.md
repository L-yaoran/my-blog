...
│       python_basic_test_005-1.html#   练习 005-1 — 线程/生成器/协程（34 题）
│       python_basic_test_005-2.html#   练习 005-2 — 线程/锁/GIL 补充（32 题）
│
└── 回收站/                         # 废弃文件暂存，不参与运行
```
...
**页面间导航：** 每个练习页顶部有导航栏，支持「◂ 上一练习 | 下拉菜单选择 | 下一练习 ▸」。当前共 6 套练习：001 → 002 → 003 → 004 → 005-1 → 005-2。
